...
// FIX (Secrets): klucz prywatny RSA pobierany ze zmiennej środowiskowej / sekretu CI, nie zaszyty w kodzie
...
// FIX (Secrets): klucz HMAC ze zmiennej środowiskowej zamiast literału w kodzie
const hmacKey = process.env.HMAC_SECRET ?? crypto.randomBytes(32).toString('hex')
